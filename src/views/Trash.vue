<template lang="pug">
  v-layout(row wrap)
    v-flex(xs12 md6)
      ...
      p.px-4 For all questions about trash service, including questions about what items are accepted or missed pickup, please call Greene Waste Services at 724&dash;943&dash;4232.
    v-flex(xs12 md6)
      img(:src="src" :alt="alt" )
