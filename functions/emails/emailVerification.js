...
const build = (templateData) => {
  let contents = header.build() + greeting.build(templateData.greeting) + primaryMessage.build(templateData.primaryMessage) + userInfo.build(templateData.userInfo) + buttonAction.build(templateData.buttonAction) + closing.build(templateData.closing)
